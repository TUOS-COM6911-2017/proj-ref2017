...
d1<-UnusualPubliHealth[,.(NameOfUniversity,FourStarOutput,UnusualWordsOutput,category='PublicHealth')]
d2<-UnusualBiolScience[,.(NameOfUniversity,FourStarOutput,UnusualWordsOutput,category="BiolScience")]
d3<-UnusualPhysics[,.(NameOfUniversity,FourStarOutput,UnusualWordsOutput,category="Physics")]
d4<-UnusualComputerScience[,.(NameOfUniversity,FourStarOutput,UnusualWordsOutput,category="ComputerScience")]
d5<-UnusualAeroMechanic[,.(NameOfUniversity,FourStarOutput,UnusualWordsOutput,category="AeroMechanic")]
d6<-UnusualEconomics[,.(NameOfUniversity,FourStarOutput,UnusualWordsOutput,category="Economics")]
d7<-UnusualAntropology[,.(NameOfUniversity,FourStarOutput,UnusualWordsOutput,category="Antropology")]
d8<-UnusualEducation[,.(NameOfUniversity,FourStarOutput,UnusualWordsOutput,category="Education")]
d9<-UnusualPhilosophy[,.(NameOfUniversity,FourStarOutput,UnusualWordsOutput,category="Philosophy")]
d10<-UnusualCommunication[,.(NameOfUniversity,FourStarOutput,UnusualWordsOutput,category="Communication")]

rm(TableOutput)
TableOutput<-as.data.table(rbind(d1,d2,d3,d4,d5,d6,d7,d8,d9,d10))
colnames(TableOutput)<-c("University","Four","UnWords","Category")
...
TableOutput$University<-as.factor(TableOutput$University)
...
d1<-UnusualPubliHealth[,.(NameOfUniversity,FourStarOverall,UnusalWordsOverall,category='PublicHealth')]
d2<-UnusualBiolScience[,.(NameOfUniversity,FourStarOverall,UnusalWordsOverall,category="BiolScience")]
d3<-UnusualPhysics[,.(NameOfUniversity,FourStarOverall,UnusalWordsOverall,category="Physics")]
d4<-UnusualComputerScience[,.(NameOfUniversity,FourStarOverall,UnusalWordsOverall,category="ComputerScience")]
d5<-UnusualAeroMechanic[,.(NameOfUniversity,FourStarOverall,UnusalWordsOverall,category="AeroMechanic")]
d6<-UnusualEconomics[,.(NameOfUniversity,FourStarOverall,UnusalWordsOverall,category="Economics")]
d7<-UnusualAntropology[,.(NameOfUniversity,FourStarOverall,UnusalWordsOverall,category="Antropology")]
d8<-UnusualEducation[,.(NameOfUniversity,FourStarOverall,UnusalWordsOverall,category="Education")]
d9<-UnusualPhilosophy[,.(NameOfUniversity,FourStarOverall,UnusalWordsOverall,category="Philosophy")]
d10<-UnusualCommunication[,.(NameOfUniversity,FourStarOverall,UnusalWordsOverall,category="Communication")]

TableOverall<-as.data.table(rbind(d1,d2,d3,d4,d5,d6,d7,d8,d9,d10))
colnames(TableOverall)<-c("University","Four","UnWords","Category")
...
TableOverall$University<-as.factor(TableOverall$University)
...
library("reshape")
cc<-dcast(TableOverall[,c(2,4),], Category ~ Four, fun=mean)
