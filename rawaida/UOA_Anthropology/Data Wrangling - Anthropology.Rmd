---
title: "Data Wrangling and Data Management for Anthropology and Development Studies"
output: html_notebook
---

Units of Assessment Studied: Anthropology and Development Studies - UOA 24
...
library(readr)
StaffSummary <- read_csv("~/03 COM6911 ITP/Data/Selected/24 - Anthropology and Development Studies (1)/Anthropology_StaffSummary.csv", 
    col_types = cols(MultipleSubmission = col_skip(), 
        TotalCategoryCHeadCount = col_skip(), 
        UnitOfAssessment = col_skip()), quote = "")
View(StaffSummary)
...
library(readr)
SubmissionProfile <- read_csv("~/03 COM6911 ITP/Data/Selected/24 - Anthropology and Development Studies (1)/Anthropology_SubmissionProfile.csv", 
    col_types = cols(MultipleSubmission = col_skip(), 
        UnitOfAssessment = col_skip()), quote = "")
...
library(readr)
Output <- read_csv("~/03 COM6911 ITP/Data/Selected/24 - Anthropology and Development Studies (1)/Anthropology_Output.csv", 
...
Comment - Data loading error - Need to be pre-processed for item d above. Based on viewed data, need to delete 1st row of the table, but these error will be omitted as the data will be pre-processed to its own UOA only. 
