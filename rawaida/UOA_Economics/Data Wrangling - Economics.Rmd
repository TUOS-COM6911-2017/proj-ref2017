---
title: "Data Wrangling and Data Management for Economics & Econometrics"
output: html_notebook
---

Units of Assessment Studied: Economics & Econometrics - UOA 18
...
library(readr)
StaffSummary <- read_csv("~/03 COM6911 ITP/Data/Selected/18 - Economics and Econometrics (1)/Economics_StaffSummary.csv", 
...
library(readr)
SubmissionProfile <- read_csv("~/03 COM6911 ITP/Data/Selected/18 - Economics and Econometrics (1)/Economics_SubmissionProfile.csv", 
    col_types = cols(MultipleSubmission = col_skip(), 
        UnitOfAssessment = col_skip()), quote = "")
...
library(readr)
Output <- read_csv("~/03 COM6911 ITP/Data/Selected/18 - Economics and Econometrics (1)/Economics_Output.csv", 
