---
title: "Data Wrangling and Data Management for Education"
output: html_notebook
---

Units of Assessment Studied: Education - UOA 25
...
library(readr)
StaffSummary <- read_csv("~/03 COM6911 ITP/Data/Selected/25 - Education (1)/Education_StaffSummary.csv", 
...
library(readr)
SubmissionProfile <- read_csv("~/03 COM6911 ITP/Data/Selected/25 - Education (1)/Education_SubmissionProfile.csv", 
    col_types = cols(MultipleSubmission = col_skip(), 
        UnitOfAssessment = col_skip()), quote = "")
...
library(readr)
Output <- read_csv("~/03 COM6911 ITP/Data/Selected/25 - Education (1)/Education_Output.csv", 
