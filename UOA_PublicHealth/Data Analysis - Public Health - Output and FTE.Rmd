...
# Remove outlier
submission_outlier <- subset.data.frame(Submissions_per_univ, subset = Submissions_per_univ$UKPRN != '10007771')
submission_outlier <- subset.data.frame(submission_outlier, subset = submission_outlier$UKPRN != '10007784')

output_outlier <- subset.data.frame(Output_Rank, subset = Output_Rank$UKPRN != '10007771')
output_outlier <- subset.data.frame(output_outlier, subset = output_outlier$UKPRN != '10007784')

# Re-plot after removal of outlier
plot(submission_outlier$freq, output_outlier$FourStar, xlab = "Number of Output Submission Per University", ylab = "Four Star Score for Each University", main = "After Removal of Outlier")

cor(submission_outlier$freq, output_outlier$FourStar, method = 'spearman')

```

Correlation calculated is 0.056, confirmed low correlation between these two variables.
...
# Re-plot after removal of outlier
plot(submission_outlier$freq, output_outlier$ThreeStar)

cor(submission_outlier$freq, output_outlier$ThreeStar, method = 'spearman')
...
# Re-plot after removal of outlier
plot(submission_outlier$freq, output_outlier$avg3_4star)

cor(submission_outlier$freq, output_outlier$avg3_4star, method = 'spearman')
...
# Removal of outlier
FTE_outlier <- subset.data.frame(FTE, subset = FTE$UKPRN != '10007771')
FTE_outlier <- subset.data.frame(FTE_outlier, subset = FTE_outlier$UKPRN != '10007784')

# Re-plot after removal of outlier
plot(FTE_outlier$TotalCategoryAFte, output_outlier$FourStar, xlab = "Submitted FTE (Category A)", ylab = "Four Star Score for Each University", main = "After Removal of Outlier")

cor(FTE_outlier$TotalCategoryAFte, output_outlier$FourStar, method = 'spearman')
...
# Re-plot after removal of outlier
plot(FTE_outlier$`Scaled FTE 
of eligible staff`, output_outlier$FourStar, xlab = "Eligible FTE by HESA", ylab = "Four Star Score for Each University", main = "After Removal of Outlier")

cor(FTE_outlier$`Scaled FTE 
of eligible staff`, output_outlier$FourStar, method = 'spearman', use = "complete.obs")
